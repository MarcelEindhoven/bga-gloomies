...
class BonusTileFactoryTest extends TestCase{
    protected ?BonusTileFactory $sut = null;
    protected ?Deck $mock_cards = null;

    public function setup(): void {
        $this->mock_cards = $this->createMock(Deck::class);
        $this->sut = BonusTileFactory::create($this->mock_cards);
    }
    ...
    public function test_flush_with_single_definition() {
        ...
        $purple = 1;
        $turquoise = 2;
        $expected_definition = array( 'type' => $purple, 'type_arg' => $turquoise, 'nbr' => 1);
